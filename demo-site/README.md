...
| `/product/:id` (Product detail) | `countdown-timer-hide`, `scarcity-hide`, `reviews-hide`, `prompt-injection-hide`, `hidden-text-strip`, `html-comment-strip`, `noscript-strip`, `unicode-invisibles-strip`, `social-embed-hide` |
