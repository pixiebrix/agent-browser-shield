...
afterEach(() => {
  attributeInjectionScrubRule.teardown();
  jest.useRealTimers();
});

describe("attribute-injection-scrub candidate attributes", () => {
  it.each([
    ["aria-label", "button"],
    ...
    attributeInjectionScrubRule.apply(document.body);
...
describe("attribute-injection-scrub disabled input value", () => {
...
describe("attribute-injection-scrub lazy subtrees", () => {
...
describe("attribute-injection-scrub idempotency", () => {
